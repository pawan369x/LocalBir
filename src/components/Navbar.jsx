...
const LiveStatus = () => (
    <div className="bg-sky-50 dark:bg-slate-900/50 text-sky-900 dark:text-sky-300 h-9 flex items-center justify-center text-xs md:text-sm border-b border-sky-100 dark:border-slate-800 relative z-[60] overflow-hidden">
