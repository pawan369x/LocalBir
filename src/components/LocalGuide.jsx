                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {guides.map((guide, index) => (
                        <motion.div
                            ...
                            whileHover={{ y: -10 }}
                            className="bg-white dark:bg-slate-900 rounded-3xl p-4 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 relative overflow-hidden group transition-all duration-300"
                        >
                            {/* Image Container */}
                            ...
                            <div className="px-2 pb-4">
                                <div className="flex items-start justify-between mb-3">
                                    <div>
                                        <h4 className="font-bold text-slate-800 dark:text-slate-200 text-sm uppercase tracking-wide flex items-center gap-2">
                                ...
                                <button
                                    onClick={onBookClick}
                                    className="w-full py-3 rounded-xl bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-sm hover:bg-sky-500 hover:text-white dark:hover:bg-sky-500 dark:hover:text-white transition-all flex items-center justify-center gap-2 group-hover:shadow-md"
                                >
                                    Book with {guide.name} <Heart size={16} className="group-hover:fill-white group-hover:text-white transition-colors" />
                                </button>
                            </div>
