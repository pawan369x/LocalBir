...
const Footer = ({ onBookClick }) => {
    ...
    return (
        ...
        <footer className="bg-[#0b0f19] dark:bg-slate-950 relative pt-48 pb-10 font-sans mt-32 border-t border-slate-800/50 transition-colors duration-500">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl px-4 -translate-y-1/2 z-30">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-700 animate-gradient-x" />
                    ...
                    <div className="relative z-10 p-8 md:p-30 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                        ...
                        >
                            Take to the Skies <Send size={20} className="group-hover:translate-x-1 transition-transform" />
                        </motion.button>
                    </div>
                </motion.div>
            </div>
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                <Link to="/" className="inline-block group">
                                    <img 
                                        ...
                                        className="h-24 w-24 md:h-28 md:w-28 object-contain transition-all duration-300 scale-[2.2] group-hover:scale-[2.4] drop-shadow-[0_2px_10px_rgba(255,255,255,0.1)]"
                                    />
                                </Link>
                                {/* Live Status Badge */}
