...
const FlightDashboard = ({ onBookClick }) => {
    ...
    if (loading) return (
        <div className="py-24 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
    ...
    return (
        <section id="flight-dashboard" className="py-24 bg-slate-50 dark:bg-slate-950 relative overflow-hidden font-sans transition-colors duration-500">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row gap-12 items-center">

                    {/* LEFT: TEXT INFO */}
                    <div className="flex-1 text-center md:text-left">
                        <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-xs font-bold uppercase mb-6 animate-pulse border border-emerald-200/50 dark:border-emerald-500/20">
                        ...
                        <div className="flex flex-col gap-4">
                            {/* Live Status Card */}
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:shadow-md">
                                <div className={`p-3 ${flyStatus.bg} dark:bg-opacity-10 ${flyStatus.color} rounded-xl`}>
                                    {flyStatus.icon}
                                </div>
                                <div className="flex-1">
                                    <h4 className="font-bold text-slate-900 dark:text-white">{flyStatus.status}</h4>
                                    <p className="text-sm text-slate-500 dark:text-slate-500">{flyStatus.msg}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:shadow-md">
                                ...
                                <div className="flex-1">
                                    <h4 className="font-bold text-slate-900 dark:text-white">Best Slot Today</h4>
                                    <p className="text-sm text-slate-500 dark:text-slate-500">Sunset Flight (4:00 PM - 5:30 PM)</p>
                                </div>
                            </div>
                        </div>
                    </div>
