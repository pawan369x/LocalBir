...
const JourneyRoadmap = ({ onBookClick }) => {
    return (
        <section className="py-24 bg-slate-50 dark:bg-slate-950 relative overflow-hidden font-sans transition-colors duration-500">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-20">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-50 dark:bg-sky-500/10 border border-sky-100 dark:border-sky-500/20 text-sky-600 dark:text-sky-400 text-xs font-bold tracking-widest uppercase mb-4 shadow-sm"
                    >
                ...
                <div className="relative">
                    ...
                    <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-slate-200 dark:bg-slate-800 -translate-x-1/2">
                        <motion.div
                            initial={{ height: 0 }}
                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-0 md:top-1/2 md:-translate-y-1/2 z-20">
                                    <div className="w-16 h-16 rounded-2xl bg-slate-900 dark:bg-sky-500 text-white flex items-center justify-center shadow-xl shadow-slate-300 dark:shadow-sky-500/10 border-4 border-white dark:border-slate-800 transform transition-transform hover:scale-110 hover:bg-sky-500 hover:border-sky-100">
                                        {step.icon}
                                    </div>
                                </div>
                                ...
                                <div className={`flex-1 w-full ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                                    <div className={`inline-block px-3 py-1 rounded-lg text-xs font-bold mb-3 bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 ${index % 2 === 0 ? 'md:ml-auto' : 'md:mr-auto'}`}>
                                ...
                                <div className="flex-1 w-full flex justify-center">
                                    <div className="group relative rounded-none overflow-hidden shadow-2xl bg-white dark:bg-slate-900 p-2 border border-slate-100 dark:border-slate-800 rotate-1 hover:rotate-0 transition-all duration-500 w-full max-w-[320px]">
