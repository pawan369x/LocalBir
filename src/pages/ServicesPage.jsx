...
const Services = () => {
    const PHONE_NUMBER = "916230044384";
...
Hi Pawan, please confirm availability.
    ...
    // Structured Service Schemas for GEO and Google Rich Snippets
    const servicesSchema = [
        {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Classic Paragliding in Bir Billing",
            "provider": {
                "@type": "LocalBusiness",
                "name": "Bir Billing Guide",
                "url": "https://birbillingguide.com"
            },
            "description": "Experience classic tandem paragliding in Bir Billing with safety briefing, equipment, certified pilot, and GoPro video transfer.",
            "offers": {
                "@type": "Offer",
                "price": "3000.00",
                "priceCurrency": "INR"
        ...
        },
        {
            ...
            "description": "High-adrenaline Bungee Jumping in Bir Billing adhering to international safety protocols, video included.",
            "offers": {
                "@type": "Offer",
                "price": "3500.00",
                "priceCurrency": "INR"
        ...
        },
        {
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "Camping & Hotel Stays in Bir Billing",
            "provider": {
                "@type": "LocalBusiness",
                "name": "Bir Billing Guide",
                "url": "https://birbillingguide.com"
            },
            "description": "Homely stays, premium hotels, and cozy bonfire camping setups near the Bir Billing landing site.",
            "offers": {
                "@type": "Offer",
                "price": "1500.00",
                "priceCurrency": "INR"
    ...
    return (
        <>
            <SEO
                title="Paragliding, Trekking, Camping & Stays Booking - Services"
                description="View standard pricing for classic paragliding (₹3000), bungee jumping (₹3500), camping and stay bookings in Bir Billing with Bir Billing Guide."
                keywords="Bir Billing paragliding booking, paragliding cost, camping rates Bir Billing, scooty rentals Bir Billing, local stays, Bir Billing Guide"
                url="https://birbillingguide.com/services"
